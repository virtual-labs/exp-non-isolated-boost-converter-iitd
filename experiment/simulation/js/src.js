const src = {
  ...
  set() {
    this.allItems = {
      ...
      part_1_text: this.allImgsDom[145],
      btn_hint: this.allImgsDom[146],
      hint_box: this.allImgsDom[147],

      //experimental section images added
      beta_line_blinking: this.allImgsDom[148],
      bnt_click: this.allImgsDom[149],
      btn_firing_angle: this.allImgsDom[150],
      btn_input_voltage: this.allImgsDom[151],
      btn_load_inductance: this.allImgsDom[152],
      btn_load_resistance: this.allImgsDom[153],
      components_rl_load: this.allImgsDom[154],
      components_r_load: this.allImgsDom[155],
      rl_load_click_1: this.allImgsDom[156],
      rl_load_click_2: this.allImgsDom[157],
      rl_load_click_3: this.allImgsDom[158],
      rl_load_click_4: this.allImgsDom[159],
      r_load_click_1: this.allImgsDom[160],
      r_load_click_2: this.allImgsDom[161],
      r_load_click_3: this.allImgsDom[162],
      r_load_click_4: this.allImgsDom[163],
      val_a: this.allImgsDom[164],
      val_l: this.allImgsDom[165],
      val_r: this.allImgsDom[166],
      val_v: this.allImgsDom[167],
      circle: this.allImgsDom[168],
      formulas_procedure_slider_1: this.allImgsDom[169],
